...
export default function ReportCard({ count, title }) {
  return (
    <div className="bg-white border border-slate-100 rounded-2xl p-5 flex flex-col items-center justify-center text-center shadow-[0_2px_8px_-3px_rgba(0,0,0,0.04)] transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-[0_10px_20px_-8px_rgba(0,0,0,0.06)] hover:border-slate-200 cursor-pointer group">
